...
do
    ...
    do
        ...
        --mask_type="center" --input_nc=3 --output_nc=3 \
        --data_version=$dataset_version --dataset_mode="aligned_sliding" --loadSize=64 --crop_stride=$crop_stride \
        --model_version=$model_version --which_epoch="200" --measure_mode="MAE" \
