...
# --niter=40 --lr=0.00005 --lr_policy=cosine --fix_step=5000 --crop_image_num=64 \
# --checkpoints_dir='./log'  --model_version=$model_version --continue_train --which_epoch="160" \
# --gpu_id=0 --nThreads=4 \
...
do
    ...
    --inpainting_mode="ShiftNet" --measure_mode=$measure --checkpoints_dir='./log' --model_version=$model_version --which_epoch="40" \
