...
python ./test_sliding.py --batchSize=1 --use_spectral_norm_D=1 --which_model_netD='basic' --which_model_netG='unet_shift_triple' --model='shiftnet' --shift_sz=1 --mask_thred=1 --loadSize=64 --fineSize=64 --overlap=0 --dataset_mode='aligned_sliding' --mask_type='center' --input_nc=3 --output_nc=3 --color_mode='RGB' --inpainting_mode='ShiftNet' --measure_mode='MSE_sliding' --which_epoch='200' --normal_how_many=31 --testing_normal_dataroot='E:/CSE/AI/Mura/mura_data/d17/test/normal_8k/' --smura_how_many=31 --testing_smura_dataroot='E:/CSE/AI/Mura/mura_data/typecplus/'
...
python ./test_type_c_plus.py --batchSize=1 --use_spectral_norm_D=1 --which_model_netD='basic' --which_model_netG='unet_shift_triple' --model='shiftnet' --shift_sz=1 --mask_thred=1 --loadSize=64 --fineSize=64 --overlap=0 --dataset_mode='aligned_sliding' --mask_type='center' --input_nc=3 --output_nc=3 --color_mode='RGB' --inpainting_mode='ShiftNet' --measure_mode='MSE_sliding_TypecPlus' --which_epoch='200' --testing_normal_dataroot='' --testing_smura_dataroot='E:/CSE/AI/Mura/mura_data/typecplus/'